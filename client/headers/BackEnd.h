...
public:
    ...
    Q_PROPERTY(QString rank READ getRank NOTIFY RankChanged);
    Q_PROPERTY(QString point READ getPoint WRITE setPoint NOTIFY pointChanged);
    Q_PROPERTY(QString History READ getHistory NOTIFY HistoryChanged );
    ...
    Q_INVOKABLE void storeHistory();
    Q_INVOKABLE void changedPoint();
